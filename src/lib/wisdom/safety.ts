...
const PATTERNS: { kind: Exclude<SafetyKind, null>; terms: RegExp[] }[] = [
  {
    ...
    terms: [
      ...
      /\bcutting myself\b/i,
      /\bhelp me die\b/i,
      /\bplan to kill myself\b/i,
      /\bimmediately? in danger\b/i,
  ...
  },
  {
    ...
    terms: [
      ...
      /\b(?:my )?(?:partner|spouse|husband|wife) hits me\b/i,
      /\bsomeone is hurting me\b/i,
      /\bhurting me and i am scared\b/i,
      /\bviolence in (?:my )?house\b/i,
      /\bsexual assault\b/i,
      /\brap(?:e|ed|ing)\b/i,
  ...
  },
  {
    ...
    terms: [
      ...
      /\bdin\b/i,
      /\bkosher\b/i,
      /\bam i (?:allowed|obligated|required|permitted)\b/i,
      /\bpermitted (?:on|to)\b/i,
      /\bforbidden (?:on|to)\b/i,
      /\bruling on\b/i,
      /\bjewish law\b/i,
      /\bkeep kosher\b/i,
      /\bdrive on shabbat\b/i,
      /\belectricity on shabbat\b/i,
      /\bfast on yom kippur\b/i,
      /\bmixed fabrics\b/i,
      /\bshatnez\b/i,
      /\bconversion accepted\b/i,
      /\bpercentage to tzedakah\b/i,
      /\bwhat does jewish law (?:say|require)\b/i,
      /\bshabbat (?:can i|may i|is it)\b/i,
      /\bcan i (?:drive|use electricity|fast)\b/i,
      /\bkeep kosher\b/i,
    ],
  },
];
